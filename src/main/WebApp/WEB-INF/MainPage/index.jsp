...
<div id="retrobg">
    ...
    <div class="row" id="MainCont">
        <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title">View Current Posts</h2>
                    <p class="card-text">View current sellers item for sell,<br> you won't be able to send
                        messages until you register for an account!</p>
